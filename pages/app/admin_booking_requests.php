...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['booking_id'], $_POST['decision'])) {
    ...
    $stmt->execute();
    header('Location: ' . $self_file . '?success=' . urlencode('Booking status changed to ' . $decision)); exit;
}
