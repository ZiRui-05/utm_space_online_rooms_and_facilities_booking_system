...
<body>
    ...
    <div class="auth-card">
        ...
        <form id="signup-form" onsubmit="handleSignUp(event)">
            ...
            <div class="form-group">
                ...
                <div class="password-wrap"><input type="password" id="signup-password" placeholder="••••••••" minlength="8" oninput="updatePasswordRules()" required><button type="button" class="password-toggle" onclick="togglePasswordVisibility('signup-password', this)" aria-label="Show password" aria-pressed="false"><svg class="icon-eye" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"></path><circle cx="12" cy="12" r="3"></circle></svg><svg class="icon-eye-off" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c6.5 0 10 8 10 8a17.98 17.98 0 0 1-2.25 3.35"></path><path d="M14.12 14.12A3 3 0 0 1 9.88 9.88"></path><path d="M3 3l18 18"></path><path d="M6.58 6.58C3.95 8.35 2 12 2 12s3.5 8 10 8c1.5 0 2.86-.34 4.05-.88"></path></svg></button></div><div class="password-rules" id="password-rules">Min 8 characters + uppercase + lowercase + number + symbol.</div>
            </div>
            <div class="form-group">
                <label for="signup-confirm">Confirm Password</label>
                <div class="password-wrap"><input type="password" id="signup-confirm" placeholder="••••••••" required><button type="button" class="password-toggle" onclick="togglePasswordVisibility('signup-confirm', this)" aria-label="Show password" aria-pressed="false"><svg class="icon-eye" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"></path><circle cx="12" cy="12" r="3"></circle></svg><svg class="icon-eye-off" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.9 4.24A9.12 9.12 0 0 1 12 4c6.5 0 10 8 10 8a17.98 17.98 0 0 1-2.25 3.35"></path><path d="M14.12 14.12A3 3 0 0 1 9.88 9.88"></path><path d="M3 3l18 18"></path><path d="M6.58 6.58C3.95 8.35 2 12 2 12s3.5 8 10 8c1.5 0 2.86-.34 4.05-.88"></path></svg></button></div>
            </div>
    ...
    <script>
        ...
        function togglePasswordVisibility(inputId, button) {
            ...
            button.setAttribute('aria-label', show ? 'Password visible' : 'Password hidden');
