...
<body>
    ...
    <svg class="icon-eye" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5C5.6 5 2 12 2 12s3.6 7 10 7 10-7 10-7-3.6-7-10-7Zm0 11a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm0-2.3a1.7 1.7 0 1 0 0-3.4 1.7 1.7 0 0 0 0 3.4Z"/></svg>
    <svg class="icon-eye-off" viewBox="0 0 24 24" aria-hidden="true"><path d="M3.3 2 2 3.3l3 3C3.1 7.7 2 9.4 2 9.4S5.6 16.4 12 16.4c1.8 0 3.4-.5 4.7-1.2l4 4L22 17.9 3.3 2Zm7.2 7.2 1.8 1.8c-.1.1-.2.1-.3.1a1.7 1.7 0 0 1-1.7-1.7c0-.1.1-.2.2-.2Zm1.5-3.8c6.4 0 10 7 10 7s-1 1.9-2.8 3.5l-2.5-2.5A4 4 0 0 0 11 7.7L9.2 5.9c.9-.3 1.8-.5 2.8-.5ZM4.6 7.1 6.7 9.2a4 4 0 0 0 5.1 5.1l1.6 1.6c-.5.1-.9.1-1.4.1-4.4 0-7.3-4-8.3-5.6.4-.7.9-1.4 1.6-2.1Z"/></svg>
</button>
                            </div>
                        </div>
