...
?>
<div class="mb-8"><h1 class="text-4xl font-black text-[#36000f]">Admin Edit Booking</h1><p class="text-slate-500 mt-2">Edit the booking even after it has already been approved or rejected.</p></div>
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="bg-white rounded-xl border border-[#dcc0c2] p-6 shadow-sm">
        ...
        <a class="btn-light mt-3" href="admin_booking_requests.php">Back to Booking Requests</a>
    </div>
