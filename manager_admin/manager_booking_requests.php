...
<div class="mb-8 flex justify-between items-end">
    <div><h1 class="text-4xl font-black text-[#36000f]">Facility Manager Booking Requests</h1><p class="text-slate-500 mt-2">Facility Manager page for reviewing, approving, rejecting and editing booking requests.</p></div>
