...
<p class="md:col-span-4 text-xs text-slate-500">Selected date: <?= h($selected_date) ?> Â· Table dates: <?= h(implode(', ', $table_dates)) ?> Â· Timezone: Malaysia (Asia/Kuala_Lumpur)</p>
</form>
